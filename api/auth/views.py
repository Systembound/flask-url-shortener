...
def register_views():
    apispec.path(view=login, app=app)
    apispec.path(view=refresh, app=app)
    apispec.path(view=revoke_access_token, app=app)
    apispec.path(view=revoke_refresh_token, app=app)
